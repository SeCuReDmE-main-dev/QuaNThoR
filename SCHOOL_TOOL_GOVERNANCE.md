...
The existing Apache-2.0 project license remains active. `NOTICE` and `DISCLAIMER` add attribution, school-governance, and misuse-responsibility boundaries without changing that license.

Mathematical proof-assistance features are educational support. They do not replace human mathematical review.
